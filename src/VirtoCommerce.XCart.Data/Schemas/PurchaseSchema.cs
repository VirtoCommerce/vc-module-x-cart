    ...
    public class PurchaseSchema : ISchemaBuilder
    {
        ...
        public void Build(ISchema schema)
        {
            ...
            var addItemField = FieldBuilder<CartAggregate, CartAggregate>.Create("addItem", GraphTypeExtensionHelper.GetActualType<CartType>())
                                           ...
                                           .ResolveSynchronizedAsync(CartPrefix, "userId", _distributedLock, async context =>
                                           {
                                               ...
                                               var cartAggregate = await context.GetMediator().Send(cartCommand);
            ...
            var addItemsBulkCartField = FieldBuilder<BulkCartResult, BulkCartResult>.Create("addBulkItemsCart", GraphTypeExtensionHelper.GetActualType<BulkCartType>())
                                                 ...
                                                 .ResolveSynchronizedAsync(CartPrefix, "userId", _distributedLock, async context =>
                                                 {
                                                     ...
                                                     var result = await context.GetMediator().Send(cartCommand);
            ...
            var listField = new FieldType
            {
                ...
                Resolver = new FuncFieldResolver<object>(async context =>
                {
                    ...
                    var cartAggregate = await context.GetMediator().Send(getListQuery);
            ...
            var sharedListField = new FieldType
            {
                ...
                Resolver = new FuncFieldResolver<object>(async context =>
                {
                    ...
                    var cartAggregate = await context.GetMediator().Send(getSharedListQuery);
            ...
            listConnectionBuilder.ResolveAsync(async context => await ResolveListConnectionAsync(context));
            ...
            var addWishlistBulkItemField = FieldBuilder<BulkCartAggregateResult, BulkCartAggregateResult>.Create("addWishlistBulkItem", GraphTypeExtensionHelper.GetActualType<BulkWishlistType>())
                ...
                .ResolveAsync(async context =>
                {
                    ...
                    var cartAggregateList = await context.GetMediator().Send(command);
            ...
            _ = schema.Mutation.AddField(FieldBuilder<object, InitializeCartPaymentResult>
                ...
                .ResolveAsync(async context =>
                {
                    ...
                    var result = await context.GetMediator().Send(command);
                    return result;
        ...
        private async Task<object> ResolveListConnectionAsync(IResolveConnectionContext<object> context)
        {
