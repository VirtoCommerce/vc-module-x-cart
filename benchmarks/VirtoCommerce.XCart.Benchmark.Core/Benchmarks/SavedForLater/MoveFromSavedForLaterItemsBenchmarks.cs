...
/// remove it from the list, then save both (two real recalculates).
///
/// A fresh seeded saved-for-later list is built per call alongside the fresh cart; the Configured
