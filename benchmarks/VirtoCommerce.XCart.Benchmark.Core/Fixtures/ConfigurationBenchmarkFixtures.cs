...
/// <summary>
/// Command factories for the CONFIGURATION cluster benchmarks.
///
/// All commands target the mutate-existing-cart path: the cart already contains
/// configured line items, so every benchmark is <see cref="CartShape.Configured"/>-only
